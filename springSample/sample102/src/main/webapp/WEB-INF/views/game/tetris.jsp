...
<head>
  ...
  <style>
    body      { font-family: Helvetica, sans-serif; max-width: 1800px;}
    #tetris   {  width: 1000px;  border: 4px solid black; border-radius: 10px; background-color: #F8F8F8; }
    #stats    { display: inline-block; vertical-align: top; }
    #canvas   { display: inline-block; vertical-align: top; background: url(./image/texture.jpg); box-shadow: 10px 10px 10px #999; border: 2px solid #333; }
  ...
  <div id="tetris">
    <div id="menu">
     ...
     <span class="button blue">
			<a href="gamelist.do"><button type="button" id="btnSearch" >목록으로</button></a>
		</span>
    </div>
    <canvas id="canvas">
